  ...
  async function initHRRecord() {
    ...
    try {
      ...
      if (recordId !== null) {
        ...
        // Retrieve company name from storage if it exists for this record
    ...
    <div style={{ fontFamily: "'Segoe UI', system-ui, sans-serif", backgroundColor: "#F1F5F9", minHeight: "100vh" }}>
      ...
      <div style={{ maxWidth: "860px", margin: "60px auto", padding: "0 24px" }}>
        ...
        {loading ? (
          ...
          <div style={{ backgroundColor: "#F8FAFC", borderRadius: "14px", border: "1.5px solid #E2E8F0", padding: "40px", maxWidth: "600px", margin: "0 auto", boxShadow: "0 4px 6px -1px rgba(0,0,0,0.05)" }}>
            ...
            <button
              ...
              style={{
                ...
                backgroundColor: companyName.trim() ? "#0852C9" : "#93ABDE", color: "white",
                fontSize: "15px", fontWeight: "600", cursor: companyName.trim() ? "pointer" : "not-allowed",
